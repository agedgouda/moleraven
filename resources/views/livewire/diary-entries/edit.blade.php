<div class="flex h-full w-full flex-1 flex-col gap-6 p-6">
    ...
    <div class="grid grid-cols-1 gap-6 xl:grid-cols-3">
        ...
        <div class="space-y-6 xl:col-span-2">
            <div class="flex items-center gap-3">
                <x-entity-icon :model="$diaryEntry->character" class="h-8 w-8 shrink-0 rounded-full" />
                <span class="text-sm font-medium text-zinc-700 dark:text-zinc-300">{{ $diaryEntry->character->name }}</span>
        ...
        <div class="space-y-6">
            <livewire:components.entity-picker label="Planets" type="planet" wire:model="planetIds" :default-id="$diaryEntry->character->last_known_planet_id" />
