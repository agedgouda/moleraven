<div class="flex h-full w-full flex-1 flex-col gap-6 p-6">
    <div class="flex items-center gap-3">
        <flux:button href="{{ $returnTo ?: route('pcs.edit', $character) }}" icon="arrow-left" variant="ghost" size="sm" wire:navigate />
    ...
    <div class="grid grid-cols-1 gap-6 xl:grid-cols-3">
        ...
        <div class="space-y-6 xl:col-span-2">
            ...
            <div class="flex gap-3">
                ...
                <flux:button href="{{ $returnTo ?: route('pcs.edit', $character) }}" variant="ghost" wire:navigate>Cancel</flux:button>
            </div>
        </div>
